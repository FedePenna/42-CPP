...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    else
    {
        ...
        {    
            _hitPoints = 0;
            std::cout << "ClapTrap " << _name << " really should level up if you get one tapped..." << std::endl;
        }
        else
            _hitPoints -= amount;
...
{
    if (_hitPoints == 0)
        std::cout << "ClapTrap " << _name << " has died and cannot be repaired!" << std::endl;
    ...
    else
    {
        ...
        std::cout << "ClapTrap " << _name << " now has " << _hitPoints << " health!" << std::endl;
    }
}